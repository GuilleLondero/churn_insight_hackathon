...
public class SecurityConfig {
    ...
    public CorsConfigurationSource corsConfigurationSource() {
        ...
        config.setAllowedOrigins(List.of("*.onrender.com", "*.netlify.app","https://churninsight.netlify.app/", "http://localhost:3000", "http://127.0.0.1:5500/", "/v3/api-docs/**", "/swagger-ui.html", "/swagger-ui/**"));
